...
public class RegisterActivity extends AppCompatActivity {
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if( TextUtils.isEmpty(EmailHolder) || TextUtils.isEmpty(PasswordHolder) || TextUtils.isEmpty(PasswordHolder)) {
                    ...
                    Toast.makeText(RegisterActivity.this, "Enter invalid email address", Toast.LENGTH_SHORT).show();
    ...
    public void SQLiteTableBuild() {
        ...
        sqLiteDatabaseObj.execSQL("CREATE TABLE IF NOT EXISTS " + SQLiteHelper.TABLE_NAME + "(" + SQLiteHelper.Table_Column_ID + " PRIMARY KEY, " + SQLiteHelper.Table_Column_1_Name + " VARCHAR, " + SQLiteHelper.Table_Column_2_Email + " VARCHAR, " + SQLiteHelper.Table_Column_3_Password + " VARCHAR);");
    ...
    public void InsertDataIntoSQLiteDatabase() {
        ...
        if (EditTextEmptyHolder == true) {
            ...
            if (a > 0) {
                Toast.makeText(this, "Accound Created", Toast.LENGTH_SHORT).show();
